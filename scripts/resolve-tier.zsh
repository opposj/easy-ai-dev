...
typeset -A AGENT_DEP=(forgecode '' tmuxai '' codex '' claude '' opencode '' pi 'node' omp '' jcode '' hermes 'node' crush '' grok '' reasonix '' droid '' goose '' aider '' copilot '' cline 'bun' kilo '' kimi 'node' qwen 'node' qoder 'bun node' prime 'node uv' deepagents 'uv' openhands 'uv' deepcode 'bun' atomic '')
