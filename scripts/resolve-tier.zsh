...
typeset -A AGENT_DEP=(forgecode '' tmuxai '' codex '' claude '' opencode '' pi 'node' omp '' jcode '' hermes 'node' crush '' grok '' reasonix '' droid '' goose '' aider '' copilot '' cline 'bun node' codebuddy '' kilo '' kimi 'node' qwen 'node' mcode 'bun node' qoder 'bun node' prime 'node uv' deepagents 'uv' openhands 'uv' deepcode 'bun node' atomic '' letta '' zerostack '' mimo '')
